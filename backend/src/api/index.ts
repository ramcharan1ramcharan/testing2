...
require('./eventType').default(routes);
require('./event').default(routes);
require('./licence').default(routes);
require('./eventLogs').default(routes);
require('./eventData').default(routes);
require('./institution').default(routes);
