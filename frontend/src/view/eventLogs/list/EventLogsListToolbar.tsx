...
const EventLogsToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    eventLogsSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    eventLogsSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=eventLogs">
...
export default EventLogsToolbar;
