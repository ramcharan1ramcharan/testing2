...
const LicenceToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    licenceSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    licenceSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=licence">
