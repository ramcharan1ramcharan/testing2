...
const EventDataToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    eventDataSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    eventDataSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=eventData">
...
export default EventDataToolbar;
