...
const InstitutionToolbar = (props) => {
  ...
  const hasPermissionToCreate = useSelector(
    institutionSelectors.selectPermissionToCreate,
  );
  const hasPermissionToImport = useSelector(
    institutionSelectors.selectPermissionToImport,
  );
  ...
  return (
    <Toolbar>
      ...
      {hasPermissionToAuditLogs && (
        <Link to="/audit-logs?entityNames=institution">
