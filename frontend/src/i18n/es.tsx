const es = {
  ...
  entities: {
    eventType: {
        ...
        exporterFileName: 'exportacion_eventType',
        list: {
          menu: 'Tipos de Evento',
          title: 'Tipos de Evento',
        },
        create: {
          success: 'Tipo de Evento guardado con éxito',
        },
        update: {
          success: 'Tipo de Evento guardado con éxito',
        },
        destroy: {
          success: 'Tipo de Evento eliminado con éxito',
        },
        destroyAll: {
          success: 'Tipo de Evento(s) eliminado con éxito',
        },
        edit: {
    ...
    event: {
        ...
        label: 'Eventos',
        menu: 'Eventos',
        exporterFileName: 'exportacion_event',
        list: {
          menu: 'Eventos',
          title: 'Eventos',
        },
        ...
        destroyAll: {
          success: 'Evento(s) eliminado con éxito',
        },
        edit: {
          title: 'Editar Evento',
        },
    ...
    licence: {
        ...
        label: 'Licencias',
        menu: 'Licencias',
        exporterFileName: 'exportacion_licence',
        list: {
          menu: 'Licencias',
          title: 'Licencias',
        },
        create: {
          success: 'Licencia guardado con éxito',
        },
        update: {
          success: 'Licencia guardado con éxito',
        },
        destroy: {
          success: 'Licencia eliminado con éxito',
        },
        destroyAll: {
          success: 'Licencia(s) eliminado con éxito',
        },
        edit: {
    ...
    eventLogs: {
        ...
        menu: 'Logs de Evento',
        exporterFileName: 'exportacion_eventLogs',
        list: {
          menu: 'Logs de Evento',
          title: 'Logs de Evento',
        },
        create: {
          success: 'Log de Evento guardado con éxito',
        },
        update: {
          success: 'Log de Evento guardado con éxito',
        },
        destroy: {
          success: 'Log de Evento eliminado con éxito',
        },
        destroyAll: {
          success: 'Log de Evento(s) eliminado con éxito',
        },
        edit: {
        ...
        new: {
          title: 'Nuevo Log de Evento',
        },
        view: {
          title: 'Ver Log de Evento',
        },
        importer: {
    ...
    eventData: {
        ...
        exporterFileName: 'exportacion_eventData',
        list: {
          menu: 'Datos de Evento',
          title: 'Datos de Evento',
        },
        create: {
          success: 'Data de Evento guardado con éxito',
        },
        update: {
          success: 'Data de Evento guardado con éxito',
        },
        destroy: {
          success: 'Data de Evento eliminado con éxito',
        },
        destroyAll: {
          success: 'Data de Evento(s) eliminado con éxito',
        },
        edit: {
        ...
        new: {
          title: 'Nuevo Data de Evento',
        },
        view: {
          title: 'Ver Data de Evento',
        },
        importer: {
    ...
    institution: {
        ...
        label: 'Instituciones',
        menu: 'Instituciones',
        exporterFileName: 'exportacion_institution',
        list: {
          menu: 'Instituciones',
          title: 'Instituciones',
        },
        create: {
          success: 'Institución guardado con éxito',
        },
        update: {
          success: 'Institución guardado con éxito',
        },
        destroy: {
          success: 'Institución eliminado con éxito',
        },
        destroyAll: {
          success: 'Institución(s) eliminado con éxito',
        },
        edit: {
